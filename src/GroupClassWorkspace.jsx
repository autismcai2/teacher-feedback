...
const groupCss = `
  ...
  /* Baby-blue and Maldives-blue theme for group classes. */
  .groupShell{--baby:#DFF3FF;--maldives:#4EAFC0;--deep:#397F98;--morandi:#789BAB;--ink:#284757;--muted:#698692;--line:#D5E7EC;background:#EEF8FB;color:#284757}.groupTopbar{background:#F9FDFE;border-color:#D5E7EC}.groupBrand>span{background:#58B7C7}.backButton{color:#5E7F8E}.teacherPicker .teacherSwitch{border-color:#D1E4E9;color:#496A78}.teacherSwitch>span{background:#DFF3F7;color:#347F90}.teacherMenu{border-color:#D5E7EC}.teacherMenu>button:hover{background:#F0F8FA}.teacherMenu>button.active{background:#E2F3F7}.teacherMenu>button>span{background:#DDF2F6;color:#347F90}.teacherMenu>button>svg{color:#4EAFC0}.courseWorkspace,.studentWorkspace{border-color:#D5E7EC;box-shadow:0 6px 20px rgba(53,101,119,.07)}.courseOverview,.studentWorkspaceHeader,.workspaceSection,.studentWorkspace>.addStudentRow{border-color:#E1EDF0}.courseOverview>div>span{color:#3D91A3}.courseOverview h1,.studentFullName,.emptyTeacherState h3{color:#284757}.overviewStats b{background:#F2FAFC;color:#284757}.workspaceTitle p,.studentHeading p,.overviewStats small{color:#78929D}.groupField input,.groupField select,.quickInput,.classNotes,.tabResultEditor,.studentActions label{border-color:#D5E7EC;background:#FAFDFE}.groupField input:focus,.groupField select:focus,.quickInput:focus,.classNotes:focus,.tabResultEditor:focus{border-color:#74BCC9;box-shadow:0 0 0 2px rgba(78,175,192,.14)}.groupBrand>span,.scoreLaunch,.generateGroup{background:#4EAFC0!important}.scoreLaunch:hover,.generateGroup:hover{background:#3E98A9!important}.completion i span{background:#4EAFC0}.resultTabs button.active{border-color:#4EAFC0;color:#347F90}.secondaryAdd,.classManager>div button,.excelDownload{border-color:#BDDCE3;color:#397F98}.studentRecordCard{border-color:#D9E8EC}.studentRecordCard:nth-child(even){background:#F6FBFC}.studentRecordCard:hover{background:#EEF8FA}.studentRecordCard.editing{border-color:#91C8D2;background:#EAF6F9;box-shadow:inset 3px 0 #4EAFC0}.studentDone{color:#4EAFC0}.miniSegment.attendance .state-0.active,.miniSegment.homework .state-0.active{border-color:#B5DCE4;color:#34798A;background:#E0F2F6}.scoreCell.filled{border-color:#9CCBD6!important;background:#E9F6F8!important;color:#277D90!important}.classDialog footer .primaryDialogAction,.emptyTeacherState button{border-color:#4EAFC0;background:#4EAFC0}.emptyTeacherState>span{background:#E0F3F7;color:#4EAFC0}.recorderHeader{background:#E1F4F8}.scoreProgress i,.recorderFooter>div button.done{background:#59B8C7}.recorderModes button.active,.rangeTabs button.active{color:#347F90}.scoreButtons button.selected,.scoreComplete button{border-color:#4EAFC0;background:#4EAFC0;color:#fff}.typeScore input{border-color:#74C2CF}.scoreComplete>span{background:#E2F4F7;color:#3D91A3}
  .groupTopbar .backButton{min-height:40px;display:inline-flex;align-items:center;justify-content:center;gap:8px;border:1px solid #D1E4E9;border-radius:10px;background:#fff;color:#527684;padding:0 13px;font-size:13px;font-weight:700;box-shadow:0 4px 12px rgba(53,101,119,.07);transition:border-color 170ms ease,background 170ms ease,color 170ms ease,transform 170ms ease}.groupTopbar .backButton:hover{border-color:#9DCED7;background:#EAF6F9;color:#347F90;transform:translateY(-1px)}.groupTopbar .backButton:active{transform:translateY(0)}
